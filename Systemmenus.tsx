...
const InstaxBotSystemMenu: React.FC = () => {
  ...
  // Save system menu function with tenent ID from localStorage
  const handleSaveSystemMenu = async () => {
    ...
    try {
      ...
      const response = await fetch('https://8def-2401-4900-8827-18db-d531-34b1-a4f4-2ef9.ngrok-free.app/api/systemmenusroute/save-system-menu', {
        method: 'POST',
        headers: {
    ...
    <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-purple-500 to-purple-600 text-white p-6">
        <div className="flex items-center justify-center gap-3">
          ...
          <h1 className="text-xl font-semibold">InstaxBot System</h1>
        </div>
      </div>
        ...
        <div>
          ...
          <div className="space-y-4">
            {payloads.filter(payload => payload.type === 'payload').map((payload) => (
              <div key={payload.id} className="border border-gray-200 rounded-lg p-4 bg-blue-50">
                <div className="flex items-center justify-between mb-4">
        ...
        <div>
          ...
          <div className="space-y-4">
            {payloads.filter(payload => payload.type === 'web-url').map((payload) => (
              <div key={payload.id} className="border border-gray-200 rounded-lg p-4 bg-green-50">
                <div className="flex items-center justify-between mb-4">
