...
export default function FrontPrivacyPolicy() {
  ...
  return (
    <div
      // Multi-color pink gradient background, centered content
      className="min-h-screen 
                
                 flex flex-col justify-center items-center
                 py-6 px-4 sm:py-12 sm:px-6 lg:px-8"
    >
      <div className="w-full max-w-full sm:max-w-xl md:max-w-3xl
        ...
        <div className="px-4 py-5 sm:px-6 sm:py-6">
          <div className="flex items-center mb-5 sm:mb-8">
            <Button
              variant="outline"
              size="icon"
              className="mr-3 border-pink-400 text-pink-600 hover:bg-pink-50 hover:text-pink-700"
          ...
          >
            <div className="space-y-6 text-black text-sm sm:text-base">
              <p className="italic">
              ...
              <Section title="10. Contact Us">
                ...
                <address className="mt-2 not-italic text-sm sm:text-base">
