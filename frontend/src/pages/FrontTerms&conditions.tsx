...
export default function FrontTermsAndConditions() {
  ...
  return (
    <div className="container mx-auto p-4 max-w-4xl relative">
      ...
      {/* Title (with top margin added) */}
      <h1 className="text-3xl font-bold mb-6 text-center mt-16">Terms & Conditions</h1>
      <p className="text-sm text-muted-foreground mb-4 text-center">Last updated: December 2, 2024</p>
      ...
      <ScrollArea
        ...
        `}
      >
        <div className="prose max-w-none dark:prose-invert prose-p:text-black prose-a:text-blue-600 hover:prose-a:underline">

          {/* Agreement Section (with top margin added) */}
          <h2 className="text-2xl font-semibold mb-4 mt-8">AGREEMENT TO OUR LEGAL TERMS</h2>
          <p>
