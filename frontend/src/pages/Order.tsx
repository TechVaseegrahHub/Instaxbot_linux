...
import { RefreshCw, ChevronLeft, ChevronRight, Instagram } from 'lucide-react';
...
const OrderManagement = () => {
  ...
  const API_BASE_URL = process.env.REACT_APP_API_BASE_URL || 'https://ddcf6bc6761a.ngrok-free.app/api';
                ...
                <tbody className="divide-y divide-gray-200">
                  {orders.map((order, index) => (
                    <tr key={order.id} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                      ...
                      {/* Customer Info - Show customer_name and phone */}
                      <td className="px-4 py-4">
                        <div className="space-y-1">
                      ...
                      {/* Customer Instagram Info - Show name and username */}
                      <td className="px-4 py-4">
                        <div className="space-y-1">
